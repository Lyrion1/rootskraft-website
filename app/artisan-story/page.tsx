      ...
      <section className="space-y-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative aspect-[4/3] rounded-xl overflow-hidden shadow-xl">
            <Image
              src="https://res.cloudinary.com/dycotblov/image/upload/v1763859086/3C033763-A40C-4EEC-8492-7409BCE1E814_qsurdk.png"
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative aspect-[4/3] rounded-xl overflow-hidden shadow-xl order-1 md:order-2">
            <Image
              src="https://res.cloudinary.com/dycotblov/image/upload/v1763859584/D538C981-A702-473D-83B1-AC76365880BD_myzfco.png"
