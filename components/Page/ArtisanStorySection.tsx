  ...
  return (
    <section className="container py-20 grid md:grid-cols-2 gap-12 items-center">
      <div className="relative aspect-[3/4] rounded-xl overflow-hidden shadow-2xl dark:shadow-secondary/20">
        <Image
          src="https://placehold.co/800x1000/3e2723/fff"
      ...
      <div className="space-y-6">
        <h2 className="text-sm uppercase font-sans tracking-[0.3em] text-secondary font-bold">
          Root & Hide Co.
        </h2>
        ...
        <p className="text-lg text-muted-foreground leading-relaxed">
          The name RootHaus embodies the strength of the Iroko tree and the
          deep roots of Nigerian craft. Every piece we create—from the Oba
          Wallet to the Ngozi Handbag—is a symbol of <strong>balance</strong>{' '}
          and <strong>justice</strong>, meticulously crafted using
          ethically-sourced, luxurious hides.
        </p>
        ...
        <Button
          ...
          size="lg"
          variant="outline"
          className="mt-4 border-primary dark:border-secondary text-primary dark:text-secondary tracking-widest hover:bg-primary/5 dark:hover:bg-secondary/10"
        >
