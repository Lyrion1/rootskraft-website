...
const IMAGE_URLS = {
  ...
  chikaCrossbody: 'https://res.cloudinary.com/dycotblov/image/upload/v1763859086/3C033763-A40C-4EEC-8492-7409BCE1E814_qsurdk.png', // crossbody_logo
  ...
  temiHarness: 'https://res.cloudinary.com/dycotblov/image/upload/v1763859139/5B7B7B98-08B6-4799-BE3B-81D6AC547B43_cobjeh.png', // keyholder_brown (harness)
  bisiWalkSet: 'https://res.cloudinary.com/dycotblov/image/upload/v1763859229/AC63DAF7-C010-43EC-9893-25B08801FB56_zxbg35.png', // walk set
  ayoTwinningSet: 'https://res.cloudinary.com/dycotblov/image/upload/v1763858399/A_pair_of_digital_photographs_showcases_a_luxuriou_opvylo.png', // twinning set

  // ACCESSORIES & HOMEWARE
  militaryTag: 'https://res.cloudinary.com/dycotblov/image/upload/v1763859465/B90C6441-561D-4A13-A371-739A9A8690B8_ny7omx.png', // military tag
  gemstoneTag: 'https://res.cloudinary.com/dycotblov/image/upload/v1763859252/F7181C8D-75DC-4BAD-9BDA-260669315512_dyirsg.png', // gemstone tag
  leahGiftSet: 'https://res.cloudinary.com/dycotblov/image/upload/v1763858338/A_digital_photograph_displays_two_black_leather_wa_njicrb.png', // gift set packaging
  embossedLogoSet: 'https://res.cloudinary.com/dycotblov/image/upload/v1763859183/6DEFC432-FB86-41D4-912C-94ED93A737FF_dekn4z.png', // logo embossed set
...
// Category type for URL-friendly category slugs used in collection pages
export type ProductCategory = 'men' | 'women' | 'girls' | 'boys' | 'pets' | 'accessories-homeware' | 'gift-sets';
...
export const products: Product[] = [
  // MEN Collection
  { id: 'men-ade-belt', name: 'Ade Belt', slug: 'ade-belt', collection: 'Men', category: 'men', subcategory: 'Belts', price: 25000, 
  ...
  { id: 'men-oba-wallet', name: 'Oba Wallet', slug: 'oba-wallet', collection: 'Men', category: 'men', subcategory: 'Wallets', price: 18000, 
  ...
  { id: 'men-ajani-strap', name: 'Ajani Strap', slug: 'ajani-strap', collection: 'Men', category: 'men', subcategory: 'Accessories', price: 12500, 
  ...
  { id: 'men-ife-dopp', name: 'Ife Dopp Kit', slug: 'ife-dopp-kit', collection: 'Men', category: 'men', subcategory: 'Travel', price: 35000, 
  ...
  // WOMEN Collection
  { id: 'women-ngozi-bag', name: 'Ngozi Handbag', slug: 'ngozi-handbag', collection: 'Women', category: 'women', subcategory: 'Handbags', price: 85000, 
  ...
  { id: 'women-ezinne-clutch', name: 'Ezinne Clutch', slug: 'ezinne-clutch', collection: 'Women', category: 'women', subcategory: 'Clutches', price: 45000, 
  ...
  { id: 'women-chika-crossbody', name: 'Chika Crossbody', slug: 'chika-crossbody', collection: 'Women', category: 'women', subcategory: 'Bags', price: 55000, 
  ...
  // GIRLS Collection
  { id: 'girls-ada-backpack', name: 'Ada Mini Backpack', slug: 'ada-mini-backpack', collection: 'Girls', category: 'girls', subcategory: 'Bags', price: 35000, 
  ...
  { id: 'girls-chioma-purse', name: 'Chioma Crossbody Purse', slug: 'chioma-crossbody-purse', collection: 'Girls', category: 'girls', subcategory: 'Purses', price: 22000, 
  ...
  // BOYS Collection
  { id: 'boys-emeka-wallet', name: 'Emeka Youth Wallet', slug: 'emeka-youth-wallet', collection: 'Boys', category: 'boys', subcategory: 'Wallets', price: 15000, 
  ...
  { id: 'boys-chukwu-belt', name: 'Chukwu Junior Belt', slug: 'chukwu-junior-belt', collection: 'Boys', category: 'boys', subcategory: 'Belts', price: 18000, 
  ...
  // PETS Collection
  { id: 'pets-odogwu-collar', name: 'Odogwu Collar', slug: 'odogwu-collar', collection: 'Pets', category: 'pets', subcategory: 'Collars', price: 15000, 
  ...
  { id: 'pets-temi-harness', name: 'Temi Harness', slug: 'temi-harness', collection: 'Pets', category: 'pets', subcategory: 'Harnesses', price: 28000, 
  ...
  { id: 'pets-bisi-set', name: 'Bisi Walk Set', slug: 'bisi-walk-set', collection: 'Pets', category: 'pets', subcategory: 'Sets', price: 38000, 
  ...
  { id: 'pets-ayo-twinning', name: 'Ayo Twinning Set', slug: 'ayo-twinning-set', collection: 'Pets', category: 'pets', subcategory: 'Sets', price: 60000, 
  ...
  // ACCESSORIES & HOMEWARE
  { id: 'accessories-military-tag', name: 'Military Dog Tag', slug: 'military-dog-tag', collection: 'Extras', category: 'accessories-homeware', subcategory: 'Tags', price: 8000, 
  ...
  { id: 'accessories-gemstone-tag', name: 'Gemstone Dog Tag', slug: 'gemstone-dog-tag', collection: 'Extras', category: 'accessories-homeware', subcategory: 'Tags', price: 10000, 
  ...
  { id: 'accessories-leah-gift', name: 'Leah Gift Set', slug: 'leah-gift-set', collection: 'Gift Sets', category: 'accessories-homeware', subcategory: 'Sets', price: 40000, 
  ...
  { id: 'accessories-logo-kit', name: 'RootHaus Embossed Logo Set', slug: 'embossed-logo-set', collection: 'Gift Sets', category: 'accessories-homeware', subcategory: 'Sets', price: 15000, 
